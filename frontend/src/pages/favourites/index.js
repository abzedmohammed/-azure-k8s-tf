                          ...
                          <li className="share">
                            ...
                            <div className="share-box">
                              <div className="d-flex align-items-center">
                                <a href="#" className="share-ico"><i className="fa fa-share-alt"></i></a>
                                <a href="#" className="share-ico"><i className="fa fa-youtube"></i></a>
                                <a href="#" className="share-ico"><i className="fa fa-instagram"></i></a>
                              </div>
                            </div>
                          </li>
                          <li>
                  ...
                  <li className="slide-item">
                    <div className="block-images position-relative">
                      <div className="img-box">
                        <img src="../../assets/images/dragon.jpg" className="img-fluid" alt="" />
                      </div>
                      <div className="block-description">
                        <h6 className="iq-title">
                          <a href="#"> War </a>
